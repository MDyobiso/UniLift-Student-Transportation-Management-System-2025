...
import { User, Mail, Phone, CreditCard, Edit, Save, X, RefreshCcw, Lock, Clock } from "lucide-react"
...
export function DriverProfile() {
  ...
  const fetchProfileAndStats = useCallback(async () => {
    ...
    // Use driver_id from the updated AuthUser interface
    ...
    try {
      const [profileResponse, statsResponse] = await Promise.all([
        ...
        fetch(`/api/stats/driver/${currentUser.driver_id}`), // Assuming a similar stats endpoint exists
      ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      availability_status: formData.availability_status ? 'Available' : 'Not Available', // Corrected this line
