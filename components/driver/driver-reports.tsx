        ...
        <Card>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={250}>
              <LineChart data={stats.ridesTrend}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="month" />
                <YAxis />
                <Tooltip />
                <Line type="monotone" dataKey="rides" stroke="hsl(var(--primary))" strokeWidth={2} name="Rides" />
              </LineChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={250}>
              <LineChart data={stats.ridesTrend}>
                ...
                <Line type="monotone" dataKey="rating" stroke="hsl(var(--accent))" strokeWidth={2} name="Rating" />
              </LineChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
